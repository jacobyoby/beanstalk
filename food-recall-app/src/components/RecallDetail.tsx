    ...
    <div className="fixed inset-0 z-50 flex">
      ...
      <div className="w-full max-w-lg bg-white dark:bg-zinc-800 h-full overflow-auto p-6 shadow-xl">
        <div className="flex justify-between items-start gap-4">
          <h2 className="text-lg font-bold dark:text-zinc-100">{recall.productDescription}</h2>
          <button onClick={onClose} className="border dark:border-zinc-600 rounded-lg px-3 py-1 text-sm shrink-0 dark:text-zinc-200 hover:bg-zinc-100 dark:hover:bg-zinc-700">Close</button>
        </div>

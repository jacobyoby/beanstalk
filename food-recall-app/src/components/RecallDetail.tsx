  ...
  return (
    <div className="fixed inset-0 z-50 flex" role="dialog" aria-modal="true" aria-labelledby="recall-title">
      ...
      <div className="w-full max-w-lg bg-white dark:bg-zinc-800 h-full overflow-auto p-6 shadow-xl">
        ...
        <a
          href={`https://www.accessdata.fda.gov/scripts/ires/index.cfm?Product=${
        ...
        <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-2">
          Developer: <a href={`https://api.fda.gov/food/enforcement.json?search=recall_number:"${encodeURIComponent(recall.recallNumber)}"`} target="_blank" rel="noreferrer" className="underline">raw openFDA JSON</a>
        </p>
      </div>
    </div>
  )

...
export const mockEvents: AdverseEvent[] = [
  {
    ...
    products: [
      {
        nameBrand: "DEMO Jalapeño Peppers",
        industryCode: "23",
        industryName: "Vegetables/Vegetable Products",
        role: "SUSPECT",
      },
    ],
  ...
  },
  {
    ...
    products: [
      {
        nameBrand: "DEMO Powdered Whole Milk",
        industryCode: "09",
        industryName: "Milk/Butter/Dried Milk Products",
        role: "SUSPECT",
      },
    ],
  ...
  },
  {
    ...
    products: [
      {
        nameBrand: "DEMO Dark Chocolate Bar",
        industryCode: "34",
        industryName: "Bakery Prod/Dough/Mix/Icing",
        role: "SUSPECT",
      },
  ...
  },
  {
    ...
    products: [
      {
        nameBrand: "DEMO Prepared Pasta Meals",
        industryCode: "37",
        industryName: "Multiple Food Dinner/Grav/Sauce/Special",
        role: "SUSPECT",
      },
    ],
  ...
  },
  {
    ...
    products: [
      {
        nameBrand: "DEMO Aquafaba Powder",
        industryCode: "24",
        industryName: "Vegetables/Vegetable Products",
        role: "SUSPECT",
      },
  ...
  },
  {
    ...
    products: [
      {
        nameBrand: "DEMO Moringa Leaf Powder",
        industryCode: "25",
        industryName: "Vegetables/Vegetable Products",
        role: "SUSPECT",
      },

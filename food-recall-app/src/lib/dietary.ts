...
export function getDietaryMatches(
  recall: { productDescription: string; reasonForRecall: string },
  selected: DietaryConcern[],
): Array<{ concern: DietaryConcern; field: "reason" | "product"; term: string }> {
...
export function matchesDietaryConcerns(
  recall: { productDescription: string; reasonForRecall: string },
  selected: DietaryConcern[],
): boolean {

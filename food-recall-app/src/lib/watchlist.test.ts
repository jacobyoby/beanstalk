...
import { addToWatchlist, getWatchlist, matchesWatchlist, removeFromWatchlist, saveWatchlist } from "./watchlist";
...
describe("matchesWatchlist", () => {
  it("returns matching terms", () => {
    const matches = matchesWatchlist("Potential Salmonella contamination in peanut butter", ["salmonella", "listeria"]);
  ...
  it("returns all matching terms", () => {
    const matches = matchesWatchlist("Undeclared peanut and milk allergens", ["peanut", "milk", "soy"]);
